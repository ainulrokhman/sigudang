                    ...
                    <div class="col mx-auto">
                        <div class="p-5">
                            ...
                            <form class="user" action="register" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="telp" placeholder="No HP" name="telp" value="<?= set_value('telp'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" id="pass" placeholder="Ulangi Password" name="pass">
                                    </div>
